...
use App\Backend\Requests\Admin\AdminRequest;
...
class AdminsController extends MainController
{
    ...
    {
        $admins = Admin::getAllPgt(config('params.perPage'));
        return view('B::admins.index', compact('admins'));
    }
    ...
    {
        $roles = Admin::$roles;
        return view('B::admins.create', compact('roles'));
    }
